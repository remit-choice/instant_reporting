  ...
  @if (config('app.env')=='production')
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{ secure_asset('assets/plugins/jqvmap/jqvmap.min.css') }}">
    <!-- Theme style -->
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ secure_asset('assets/plugins/daterangepicker/daterangepicker.css') }}">

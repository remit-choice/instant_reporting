            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header container-fluid">
                        <form action="{{ route('admin.accounts.transactions.receiving.revenue.index') }}" method="post">
                            @csrf
                            <div class="row d-flex justify-content-center">
                                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    <select class="form-control" name="search_filter" id="search_filter"
                                        ...
                                        <option value="Beneficiary Country" class="py-1">Beneficiary
                                            Country</option>
                                    </select>
                                </div>
                                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                    ...
                                    @else
                                        ...
                                        @foreach ($transactions as $transaction)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($rate != 0)
                                                        {{ number_format($total_revenue_in_gbp, 2) }}
                                                        @php
                                                            $total_revenue_in_gbp_show += $total_revenue_in_gbp;
                                                        @endphp
                                                    @else

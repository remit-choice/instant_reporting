                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                                ...
                                                <select class="form-control" name="search_filter" id="search_filter"
                                                    ...
                                                    <option value="Beneficiary Country" class="py-2">Beneficiary Country
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                ...
                                <div class="card-body">
                                    <table id="example1"
                                        ...
                                        <tbody>
                                            ...
                                            $vol_in_gbp = round($transaction->payin_amt - $transaction->admin_charges,
                                            2);
                                            $vol_in_gbp_show += $vol_in_gbp;
                                            } elseif ($transaction->payin_ccy != 'GBP' && $rate != 0) {
                                            $vol_in_gbp = round($transaction->payin_amt / $rate -
                                            $transaction->admin_charges, 2);
                                            $vol_in_gbp_show += $vol_in_gbp;
                                            } else {
                                            }
                                            ...
                                            $fx_in_fc = 0;
                                            $fx_in_fc = round((($transaction->buyer_dc_rate - $transaction->agent_rate)
                                            * ($transaction->payin_amt - $transaction->admin_charges)) /
                                            $transaction->buyer_dc_rate, 2);

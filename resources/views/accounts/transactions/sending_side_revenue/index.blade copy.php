                                                    ...
                                                    @else
                                                        ...
                                                        @foreach ($transactions as $transaction)
                                                            @php
                                                                ...
                                                                $fx_in_fc = 0;
                                                                // $buyer_dc_rate = 1;
                                                                //$buyer_dc_rate = $transaction->buyer_dc_rate;
                                                                ...
                                                                // if ($transaction->buyer_dc_rate != null && $transaction->buyer_dc_rate != 0) {
                                                                //     $fx_in_fc = (((int) $transaction->buyer_dc_rate - (int) $transaction->agent_rate) * ((int) $transaction->payin_amt - (int) $transaction->admin_charges)) / ((int) $transaction->buyer_dc_rate);
                                                                //     // var_dump($fx_in_fc);
                                                                //     $fx_in_fc = number_format($fx_in_fc, 2);
                                                                // } else {
                                                                //     $fx_in_fc = (((int) $transaction->buyer_dc_rate - (int) $transaction->agent_rate) * ((int) $transaction->payin_amt - (int) $transaction->admin_charges)) / $buyer_dc_rate;
                                                                //     $fx_in_fc = number_format($fx_in_fc, 2);
                                                                // }

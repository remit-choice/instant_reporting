                                    ...
                                    <table id="example1"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{
                                                    number_format(floor($transaction->net_admin_charges_in_gbp*100)/100,
                                                    2) }}
                                                </td>
                                                <td>
                                                ...
                                                <td>{{ number_format(floor($transaction->total_revenue_in_gbp*100)/100,
                                                    2) }}
                                                </td>
                                            ...
                                            $currencies_rates = App\Models\Currency::where('currency',
                                            $transaction->payin_ccy)
                                            ->ordoesntHave('rates')
                                            ...
                                            $fx_in_fc = 0;
                                            $fx_in_fc = (($transaction->buyer_dc_rate - $transaction->agent_rate) *
                                            ($transaction->payin_amt - $transaction->admin_charges)) /
                                            $transaction->buyer_dc_rate;
                                            ...
                                            $transaction->admin_charges / $rate;
                                            ...
                                            if ($fx_loss > 0) {
                                            $fx_loss = 0;
                                            } elseif ($fx_loss < 0) { } else { } } //Total revenue in gbp
                                                $total_revenue_in_gbp=$fx_in_GBP + $net_admin_charges_in_gbp; @endphp
                                                @if ($rate !=0) <tr>
                                                <td>{{ $counter++ }}</td>
                                                <td>{{ $transaction->customer_country }}</td>
                                                <td>{{ $count = 1 }}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ number_format(floor($net_admin_charges_in_gbp_show*100)/100,
                                                        2) }}</td>
                                                    <td>{{ number_format(floor($fx_loss_show*100)/100, 2) }}</td>
                                                    <td>{{ number_format(floor($total_revenue_in_gbp_show*100)/100, 2)
                                                        }}</td>

                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header container-fluid">
                                    <form action="{{ route('admin.operations.transactions.customers') }}" method="post">
                                        {{ csrf_field() }}
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered @php if(!empty($customers)){echo " table-responsive";}else{} @endphp">
                                        <thead>
                                            <tr>
                                                <th>#</th>

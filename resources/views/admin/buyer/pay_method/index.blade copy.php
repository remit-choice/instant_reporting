                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div id="success" class="alert alert-default-success alert-dismissible fade show" buyer="alert" style="display: none">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 mt-2">
                                ...
                                <a type="button" href="#" data-toggle="modal" data-target="#buyer_pay_method_create" class="border px-2 btn" style="background-color: #091E3E;color: white">
                                    Add Buyer Currency
                                </a>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="create_buyer_status" class="text-capitalize">
                                                            <div class="input-group">
                                                                <input type="checkbox" name="create_buyer_status me-2" id="create_buyer_status" value="0">Status
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <button type="submit" class="border px-2 btn create" style="background-color: #091E3E;color: white">Save</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $counter++ }} <input type="hidden" name="db_buyer_id" class="db_buyer_id" value="{{ $buyer->id }}">
                                                    <input type="hidden" name="db_buyer_payment_method_id" class="db_buyer_payment_method_id" value="{{ $buyer_payment_method->id }}">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu edit_buyer_pay_method" aria-labelledby="dropdownMenuButton">
                                                            {{-- <a class="dropdown-item" type="button" href="#"
                                                                        data-toggle="modal" data-target="#buyer_pay_method_update">
                                                                        Edit</a> --}}
                                                            <li>
                                                                <a class="dropdown-item" type="button" href="#" data-toggle="modal" data-target="#buyer_pay_method_update">
                                                                    Edit</a>
                                                            </li>
                                                            <li>
                                                                <form action="{{route('admin.buyer.pay_method.delete',['id'=>$id])}}" method="POST" class="buyer_pay_method_delete_form">
                                                                    @csrf
                                                                    <input type="hidden" name="id" class="id" value="{{ $buyer_payment_method->id }}">
        ...
        <div class="modal fade" id="buyer_pay_method_update">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <select class="form-control" name="payment_methods" id="edit_payment_method_id" required disabled>
                                    <option selected hidden disabled>SELECT</option>
                                    @foreach ($payment_methods as $payment_method)
                                    <option value="{{ $payment_method->id }}">{{ $payment_method->name }}</option>
                                    @endforeach
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" class="border px-2 btn update" style="background-color: #091E3E;color: white">Update</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>

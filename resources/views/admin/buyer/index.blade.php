            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="custom-control custom-checkbox">
                          <input class="custom-control-input create_buyer_status" type="checkbox" id="create_buyer_status" checked value="1">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input edit_buyer_status" type="checkbox" id="edit_buyer_status" value="0">

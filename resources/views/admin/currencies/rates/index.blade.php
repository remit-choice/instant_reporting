                                    ...
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                        ...
                                        @if (request()->input('date'))
                                            <input type="date" name="date" id=""
                                                class="form-control"
                                                value="{{ request()->input('date', old('date')) }}"
                                                style="width: 100%">
                                        @else
                                            <input type="date" name="date" id=""
                                                class="form-control" value="@php echo \Carbon\Carbon::now()->format('Y-m-d'); @endphp" style="width: 100%">
                                        @endif
                                    </div>
    ...
    <form action="{{ route('admin.currencies.rates.create') }}" method="POST"
        id="create_modal_form" autocomplete="off">
        @csrf

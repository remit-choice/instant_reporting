                        ...
                        <div class="modal fade" id="currency_rate_create">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.currencies.rates.create') }}" method="POST" id="currency_rate_create_form" autocomplete="off">
                                        @csrf
                                        <div class="modal-body">
                                            <div id="failes" class="alert alert-default-danger alert-dismissible fade show" role="alert" style="display: none">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-6">
                                                    <label for="create_currency_min_rate" class="text-capitalize">min
                                                        rate</label>
                                                    <input type="text" name="create_currency_min_rate" id="create_currency_min_rate" class="form-control" readonly>
                                                </div>
                                                <div class="col-6">
                                                    <label for="create_currency_max_rate" class="text-capitalize">max
                                                        rate</label>
                                                    <div class="input-group">
                                                        <input type="text" name="create_currency_max_rate" id="create_currency_max_rate" class="form-control" readonly>
                                                        <input type="hidden" name="create_currency_iso" id="create_currency_iso" value="">
                                                        <input type="hidden" name="create_currency_iso3" id="create_currency_iso3" value="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="create_currency_rate" id="create_currency_rate" class="form-control">
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="card w-100">
                                    <div class="card-header w-100 d-flex justify-content-between">
                                        ...
                                        <form action="{{ route('admin.currencies.rates.filter') }}" method="post" class="col-3 float-right d-flex flex-row">
                                            @csrf
                                            <input type="date" name="date" id="filter_date" class="form-control mr-2" value="@php if (session()->has('dated')){echo session()->get('dated'); }else{echo \Carbon\Carbon::now()->format('Y-m-d');} @endphp">
                                            <button type="submit" name="filter" class="btn mb-2" style="background-color: #091E3E;color: white">Submit</button>
                                        </form>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $counter++ }} <input type="hidden" name="db_currency_id" class="db_currency_id" value="{{ $currency->id }}">
                                                    </td>
                                                    <td>{{ $currency->name }}</td>
                                                    <td>{{ $currency->iso }}<input type="hidden" name="db_currency_iso" class="db_currency_iso" value="{{ $currency->iso }}">
                                                    </td>
                                                    <td>{{ $currency->iso3 }}
                                                        <input type="hidden" name="db_currency_iso3" class="db_currency_iso3" value="{{ $currency->iso3 }}">
                                                    </td>
                                                    <td>{{ $currency->dial }}</td>
                                                    <td>{{ $currency->currency }}
                                                        <input type="hidden" name="db_currency" class="db_currency" value="{{ $currency->currency }}">
                                                    </td>
                                                    <td>{{ $currency->currency_name }}</td>
                                                    <td id="min_rate{{ $currency->id }}">
                                                        {{ $currency->min_rate }} <input type="hidden" name="db_currency_min_rate" class="db_currency_min_rate" value="{{ $currency->min_rate }}">
                                                    </td>
                                                    <td id="max_rate{{ $currency->id }}">
                                                        {{ $currency->max_rate }} <input type="hidden" name="db_currency_max_rate" class="db_currency_max_rate" value="{{ $currency->max_rate }}">
                                                    </td>
                                                    ...
                                                    <td id="rate{{ $rate->id }}">
                                                        {{ $rate->rate }}
                                                        <input type="hidden" name="db_currency_rate_id" class="db_currency_rate_id" value="{{ $rate->id }}">
                                                        <input type="hidden" name="db_currency_rate" class="db_currency_rate" value="{{ $rate->rate }}">
                                                    </td>
                                                    @endif
                                                    @endforeach
                                                    @else
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            @if (!$currency->rates->isEmpty())
                                                            <div class="dropdown-menu edit_currency" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item" type="button" href="#" data-toggle="modal" data-target="#currency_rate_update">
                                                                    Edit Rate</a>
                                                            </div>
                                                            @else
                                                            <div class="dropdown-menu create_currency" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item" type="button" href="#" data-toggle="modal" data-target="#currency_rate_create">
                                                                    Add Rate</a>
                                                            </div>
                                                            @endif
                                                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.currencies.rates.update') }}" method="post" autocomplete="off">
                        @csrf
                        <div class="modal-body">
                            <div id="update_failes" class="alert alert-default-danger alert-dismissible fade show" role="alert" style="display: none">
                                <span class="text_fails"></span>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="currency_rate" id="currency_min_rate" class="form-control" readonly>
                                </div>
                                <div class="col-6">
                                    <label for="currency_max_rate" class="text-capitalize">max rate</label>
                                    <input type="text" name="currency_rate" id="currency_max_rate" class="form-control" readonly>
                                </div>

                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <tbody>
                                    ...
                                    @elseif ($type == 1)
                                        <form
                                            action="{{ route('admin.role.permission.edit', [Session::get('roll_id')]) }}"
                                            method="POST">
                                            @csrf
                                            @foreach ($modules_groups as $modules_group)
                                                <tr class="checoboxes">
                                            ...
                                            @endforeach
                                            <div class="d-flex justify-content-between">
                                                <a href="/admin/setting/role"
                                                    class="btn btn-primary float-end my-4">Back</a>
                                                <button type="submit" id="Save"
                                                    class="btn btn-primary float-end my-4">
                                                    Save changes
                                                </button>
                                            </div>
                                        </form>

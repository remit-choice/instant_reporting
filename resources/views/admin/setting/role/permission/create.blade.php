                            ...
                            <tbody>
                                ...
                                <form
                                    ...
                                    <tr class="checoboxes">
                                        ...
                                        <td>
                                            <input type="checkbox" name="view[{{ $counter }}]" class="check" value="0">
                                        </td>
                                        <td>
                                            <input type="checkbox" name="add[{{ $counter }}]" class="check" value="0">
                                        </td>
                                        <td>
                                            <input type="checkbox" name="edit[{{ $counter }}]" class="check" value="0">
                                        </td>
                                        <td>

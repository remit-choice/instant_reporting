                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <span class="invalid-feedback"
                                                                id="create_module_group_name_error">
                                                            </span>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <span class="invalid-feedback"
                                                                id="create_module_group_icon_error">
                                                            </span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="module_group_status" class="text-capitalize">
                                                                <div class="input-group">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        id="create_module_group_status" value="0">Status
                                                                </div>
                                                            </label>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card-body datatable_data">
                                    <table id="example2" class="table table-bordered table-striped">
                                        ...
                                        <tbody class="role_data" id="tablecontents">
                                            ...
                                            <tr class="row1" data-id="{{ $module_group->id }}">
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback" id="module_group_name_error">
                            </span>
                        </div>
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback" id="module_group_icon_error">
                            </span>
                        </div>
                        <div class="form-group">
                            <label for="module_group_status" class="text-capitalize">
        ...
        $(function() {
            ...
            $('.create').click(function(e) {
                ...
                if (name != '' && icon != '') {
                    ...
                    if (name == '') {
                        $('#create_module_group_name_error').show();
                        $('#create_module_group_name_error').html(
                            "Required!");
                        window.setInterval(function() {
                            $('#create_module_group_name_error').slideUp('slow');
                            $('#create_module_group_name_error').empty();
                        }, 4000);
                    }
                    if (icon == '') {
                        $('#create_module_group_name_error').show();
                        $('#create_module_group_icon_error').html(
                            "Required!");
                        window.setInterval(function() {
                            $('#create_module_group_icon_error').slideUp('slow');
                            $('#create_module_group_icon_error').empty();
                        }, 4000);
                    }
                }
            });
            $('.update').click(function(e) {
                ...
                if (name != '' && icon != '') {
                    ...
                    if (name == '') {
                        $('#module_group_name_error').show();
                        $('#module_group_name_error').html(
                            "Required!");
                        window.setInterval(function() {
                            $('#module_group_name_error').slideUp('slow');
                            $('#module_group_name_error').empty();
                        }, 4000);
                    }
                    if (icon == '') {
                        $('#module_group_name_error').show();
                        $('#module_group_icon_error').html(
                            "Required!");
                        window.setInterval(function() {
                            $('#module_group_icon_error').slideUp('slow');
                            $('#module_group_icon_error').empty();
                        }, 4000);
                    }
                }

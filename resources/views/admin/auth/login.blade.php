...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ public_path('asset/plugins/fontawesome-free/css/all.min.css')}}">
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ public_path('asset/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ public_path('asset/dist/css/adminlte.min.css') }}">
    <link rel="stylesheet" href="{{ public_path('asset/dist/css/alt/login.css') }}">

    <script src="{{ public_path('asset/dist/js/pages/login.js')}}"></script>
    <script>
        setTimeout(function() {
            $('#failed').slideUp('slow');
...
<body class="hold-transition login-page">
    ...
    <!-- jQuery -->
    <script src="{{ public_path('asset/plugins/jquery/jquery.min.js')}}"></script>
    <!-- Bootstrap 4 -->
    <script src="{{ public_path('asset/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <!-- AdminLTE App -->
    <script src="{{ public_path('asset/dist/js/adminlte.min.js')}}"></script>
</body>
